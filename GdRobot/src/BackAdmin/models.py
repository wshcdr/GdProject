...
class Organzation(models.Model):
    ...
    orglrhomephone = models.CharField(db_column='orgLRHomephone', max_length=45, blank=True, null=True)  # Field name made lowercase.
    ...
    orgrhomephone = models.CharField(db_column='orgRHomephone', max_length=45, blank=True, null=True)  # Field name made lowercase.
